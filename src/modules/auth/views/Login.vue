...
export default {
  ...
  computed: {
    ...
    nameErrors () {
      ...
      !name.minLength && errors.push(`Insira ao menos ${name.$params.minLength.min} caracteres`)
    ...
    passwordErrors () {
      ...
      !password.minLength && errors.push(`Insira ao menos ${password.$params.minLength.min} caracteres`)
